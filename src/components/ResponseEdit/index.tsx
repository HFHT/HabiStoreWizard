        ...
        <>
            {response && response.response &&
                <div>
                    ...
                    <textarea title='weight' value={response?.response.weight} onChange={(e) => console.log(e.currentTarget.value)} placeholder='Title...' spellCheck autoCorrect='on'></textarea>
